    ...
    private void MovePlayer()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            else
            {
                ...
                currentMousePos.x = (currentMousePos.x * 10000) / Screen.width;
                currentMousePos.y = (currentMousePos.y * 10000) / Screen.height;
                ...
                Vector3 force = new Vector3(deltaPos.x * thrust, 0, deltaPos.y * thrust * 2.5F);
